<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="MentorDetails.ascx.vb" Inherits="GGBC.Smartik.Administration.Modules.MentorDetailsControl" %>
...
<div class="section-header">
    <div class="title">
        ...
        Edit <%= Server.HtmlEncode(Me.MentorName)%>  Details - <asp:Label runat="server" ID="lblTitle" />
        <a href="Mentors.aspx" title="back to sponsor list">(back to mentor list)</a>
    </div>
    <div class="options">
