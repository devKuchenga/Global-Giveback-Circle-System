...
Namespace Smartik.Administration.Modules
    Partial Public Class TypoSchoolControl
        ...
        Private Sub BindGrid()
            Dim dtSchool As DataTable = Me.DataAccessManager.GGBCGetData("sp_GetSchoolStaticData", "@SchoolId", Me.SchoolId, "@GroupID", StaticDataEnum.TypeOfSchool)
            ...
            For Each row As DataRow In dtSchool.Rows
                ...
                Me.cblTypoSchool.Items.Add(listItem)
        ...
        Public ReadOnly Property SelectedSchools As String
            Get
                ...
                For Each school As ListItem In cblTypoSchool.Items
        ...
        Public Property CssClass() As String
            Get
                Return cblTypoSchool.CssClass
            End Get
            Set(value As String)
                cblTypoSchool.CssClass = value
            End Set
        End Property
