<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InvoicePayment.ascx.vb" Inherits="GGBC.Smartik.Administration.Modules.InvoicePaymentControl" %>
...
<div class="section-header">
    <div class="title">
        ...
        Payment details for:  <%= Server.HtmlEncode(Me.MentorName)%> -
        <asp:HyperLink ID="hlExit" runat="server" Text="(Back to invoices)" />
    </div>
    <div class="options">
...
<div>
    ...
    <div>
        <asp:GridView ID="gvInvoicePayments" runat="server" AutoGenerateColumns="false" DataKeyNames="PaymentId"
            OnRowDataBound="gvInvoicePayments_RowDataBound" OnRowCommand="gvInvoicePayments_RowCommand"
            Width="100%">
            <Columns>
