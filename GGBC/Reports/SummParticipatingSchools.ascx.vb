...
Namespace Smartik.Administration.Reports
    Partial Public Class SummParticipatingSchoolsControl
        ...
        Protected Sub rptExcelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            Try
                Dim fileName As String = [String].Format("PartSchoolsSummary_{0}_{1}.xlsx", DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss"), CommonHelper.GenerateRandomDigitCode(4))
                Dim filePath As String = [String].Format("{0}files\Reports\{1}", HttpContext.Current.Request.PhysicalApplicationPath, fileName)

                ExcelHelper.SummaryParticipatingSchoolsXls(Me.DataAccessManager.GGBCGetData("rpt_SchoolMaster"), filePath)
