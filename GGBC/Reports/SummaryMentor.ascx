<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SummaryMentor.ascx.vb" Inherits="GGBC.Smartik.Administration.Reports.SummaryMentorControl" %>
        ...
        <div class="options">
            <asp:Panel runat="server" ID="pnlData">
                <asp:Button ID="rptExcel" runat="server" CssClass="adminButtonBlue" Text="Excel "
                            OnClick="rptExcelButton_Click" ValidationGroup="rptMentorSummary" />
