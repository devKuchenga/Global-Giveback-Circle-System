<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="MenteeGivebackGeneral.ascx.vb" Inherits="GGBC.Smartik.Administration.Reports.MenteeGivebackGeneralControl" %>

<div>
    <div class="section-header">
        <div class="title">
            <img src="Common/ico-sponsor.png" alt="Report" />
            Mentee Give back General Report
            <asp:Label runat="server" ID="lblTitle" />
        </div>
        <div class="options">
            <asp:Panel runat="server" ID="pnlData">
                <asp:Button ID="rptExcel" runat="server" CssClass="adminButtonBlue" Text="Excel "
                            OnClick="rptExcelButton_Click" ValidationGroup="rptmGivebackGeneral" />
