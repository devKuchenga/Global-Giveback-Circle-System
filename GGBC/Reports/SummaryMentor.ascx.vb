...
Namespace Smartik.Administration.Reports
    Partial Public Class SummaryMentorControl
        ...
        Protected Sub rptExcelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            Try
                Dim fileName As String = [String].Format("SummaryMentor_{0}_{1}.xlsx", DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss"), CommonHelper.GenerateRandomDigitCode(4))
                Dim filePath As String = [String].Format("{0}files\Reports\{1}", HttpContext.Current.Request.PhysicalApplicationPath, fileName)

                ExcelHelper.SummaryMentorsXls(Me.DataAccessManager.GGBCGetData("rpt_SummaryMentor"), filePath)
