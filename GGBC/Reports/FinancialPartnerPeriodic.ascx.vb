...
Namespace Smartik.Administration.Reports
    Partial Public Class FinancialPartnerPeriodicControl
        ...
        Protected Sub rptExcelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            Try
                Dim fileName As String = [String].Format("fPartPeriodicGeneral_{0}_{1}.xlsx", DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss"), CommonHelper.GenerateRandomDigitCode(4))
                Dim filePath As String = [String].Format("{0}files\Reports\{1}", HttpContext.Current.Request.PhysicalApplicationPath, fileName)

                ExcelHelper.GeneralFPartnerPeriodicXls(Me.DataAccessManager.GGBCGetData("rpt_PartnerMaster"), filePath)
